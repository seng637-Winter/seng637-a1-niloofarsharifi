...
In this Lab we will try to make the first bug report for the SUT, here being the ATM application. This bug report will consist on 2 aproaches or techniques.
    ...
    -Exploratory: Consist of testing the software as we see fit, this type of approach is usually taken when no documentation of a particular system exist and it does not apply only to software. As the name implies its an exploration of some sort.
